...
An open reference to the twenty-eight protocols that carry data from a sensor on a
...
| Building & industrial | M-Bus · LON · KNX · BACnet MS/TP · BACnet/IP · OPC UA |
...
src/
  ...
  content/*.mjs    the 28 protocol specs, one module per family
