...
export function comparePage() {
  ...
  const main = `      <div style="display:flex; flex-direction:column; gap:8px; margin-bottom:8px">
        ...
        <p class="p" style="max-width:74ch">The same five questions asked of all twenty-two. Rows marked <code>n/a</code> under Wires are software-layer protocols &mdash; they inherit whatever physical layer is underneath them, which is precisely the distinction people collapse when they say &ldquo;we use Modbus&rdquo;.</p>
      </div>
  ...
  return layout({
    title: 'Compare',
    description: 'All twenty-two protocols side by side: wires, topology, rate, reach and delivery guarantee.',
    canonical: 'compare/',
    nav: 'compare',
    up,
    main,
