...
const LADDER = [
  ...
  { k: 'Building & industrial', d: 'Above the copper. Typed points that carry their own units, and — in the building buses — control that keeps running with no supervisor at all.',
    p: ['MBus', 'LON', 'KNX', 'BACnetMSTP', 'BACnetIP', 'OPCUA'], c: 'var(--cat-8)' },
